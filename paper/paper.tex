...
% TODO rework section completely.
Our model predictions are conservative, with only a 6--17\% underestimation in bit requirements across relative difference thresholds ($10^{-2}$, $5\times10^{-3}$, $10^{-3}$, and $10^{-4}$). However, the model tend to overpredict the required precision by 50
