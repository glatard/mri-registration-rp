...
We ran our experiments on the \textit{Narval} cluster from Compute Canada. To enhance reproducibility and HPC support, we containerized all pipeline versions using Docker and converted them to Apptainer images using Docker2Singularity.
...
\begin{figure*}[htb!]
	\centering
	\includegraphics[width=\textwidth]{figures/hayford-pmin.pdf}
